...
The page has no CDN or network dependency. It loads the five validated figures from `reports/presentations/assets/` and can be opened directly or through a local HTTP server.
...
Open `http://localhost:8000/reports/presentations/HCC_RNAseq_downstream_advisor_20260821.html`. Use left/right arrows or Space to navigate and `F` for full screen.
